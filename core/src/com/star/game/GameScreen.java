...
public class GameScreen implements Screen {
    ...
    TextureAtlas.AtlasRegion fireBtnRegiondown;
    ...
    public void show() {
        ...
        fireBtnRegion = Assets.getInstance().mainAtlas.findRegion("button-up");
        fireBtnRegiondown = Assets.getInstance().mainAtlas.findRegion("button-down");
        background = new Background();
        powerUps = new ArrayList<PowerUp>();
        hero = new Hero();
        music = Assets.getInstance().assetManager.get("battle.wav", Music.class);
    ...
    public void render(float delta) {
        ...
        if (mgip.isTouchedInArea(1280 - 256 - 20, 50, 256, 256) > -1) {
            batch.draw(fireBtnRegiondown, 1280 - 256 - 20, 50);
        } else {
            batch.draw(fireBtnRegion, 1280 - 256 - 20, 50);
        }
        batch.end();
        if (hero.lifes < 0) {
